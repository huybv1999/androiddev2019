...
import vuhuy.kashima.exception.ValidationException;
import vuhuy.kashima.model.Extra;
import vuhuy.kashima.model.Identity;
...
public class AddServerActivity extends AppCompatActivity implements OnClickListener
{
    ...
    private void addServer()
    {
        ...
        Huy.getInstance().addServer(server);
    }
    ...
    private void updateServer()
    {
        ...
        Huy.getInstance().updateServer(server);
    }
