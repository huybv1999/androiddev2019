...
import vuhuy.kashima.Huy;
import vuhuy.kashima.protocol.IrcException;
import vuhuy.kashima.protocol.NickAlreadyInUseException;
import vuhuy.kashima.R;
import vuhuy.kashima.activity.MainActivity;
...
import vuhuy.kashima.model.ServerInfo;
import vuhuy.kashima.model.Settings;
import vuhuy.kashima.model.Status;
import vuhuy.kashima.receiver.ReconnectReceiver;
...
{
    public static final String ACTION_FOREGROUND = "vuhuy.kashima.service.foreground";
    public static final String ACTION_BACKGROUND = "vuhuy.kashima.service.background";
    public static final String ACTION_ACK_NEW_MENTIONS = "vuhuy.kashima.service.ack_new_mentions";
    public static final String EXTRA_ACK_SERVERID = "vuhuy.kashima.service.ack_serverid";
    public static final String EXTRA_ACK_CONVTITLE = "vuhuy.kashima.service.ack_convtitle";
    ...
    public void checkServiceStatus()
    {
        ...
        List<Server> servers = Huy.getInstance().getServers();
